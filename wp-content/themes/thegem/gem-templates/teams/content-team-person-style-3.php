			...
			<div class="team-person-image">
				<?php
					$thegem_sources = array(
						array('srcset' => array('1x' => 'thegem-person-240', '2x' => 'thegem-person'))
					);
					if ($params['columns'] == 4) {
						$thegem_sources = array(
							array('media' => '(max-width: 992px)', 'srcset' => array('1x' => 'thegem-person-240', '2x' => 'thegem-person')),
							array('media' => '(max-width: 1031px)', 'srcset' => array('1x' => 'thegem-person-80', '2x' => 'thegem-person')),
