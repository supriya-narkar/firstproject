...
<div class="<?php echo esc_attr($thegem_grid_class); ?> inline-column">
	<div id="post-<?php the_ID(); ?>" <?php post_class(array('team-person', 'centered-box', 'default-background')); ?>>
		<?php if(has_post_thumbnail()) : ?><div class="team-person-image"><?php echo $thegem_link_start; thegem_post_thumbnail('thegem-person-240', false, 'img-responsive', array('srcset' => array('2x' => 'thegem-person'))); echo $thegem_link_end; ?></div><?php endif; ?>
